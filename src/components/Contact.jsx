...
const Contact = () => {
  return (
    <div name ='contact' className='w-full h-screen flex justify-center items-center p-4 pt-20'>
    ...
    <img src ={airplane} alt="airplane" style={{width:'50px'}}/>
      ...
      <form method='POST' action="https://getform.io/f/2269e4c9-35b0-4bc9-b475-a75f7d418515" className='flex flex-col max-w-[600px] w-full'> 
        ...
        <button className='text-bg[#002d72] border-2 hover:bg-[#fa8072]-400 hover:border-[#text-[#fa8072] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#fa8072]-300 px-4 py-3 my-8 mx-auto flex items-center'> Let's Connect</button>
      </form>
    </div>
  )
}
